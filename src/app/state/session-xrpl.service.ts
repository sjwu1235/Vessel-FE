...
import { createUrlWith } from '../utils/http.helpers';
...
import { AccountLinesTrustline } from 'xrpl/dist/npm/models/methods/accountLines';
...
export class SessionXrplService {
  ...
  async loadAccountData(): Promise<void> {
    ...
    const xrplTrustlines: AccountLinesTrustline[] = accountLines.result.lines;
